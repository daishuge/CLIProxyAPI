...
export const FIELD_VALUE_KEYS: Record<string, readonly string[]> = {
  ...
  // ── ppap ─────────────────────────────────────────────────────────────────
  ppapPresetPromptEnabled: ['ppapPresetPromptEnabled'],
  ppapPresetPromptText: ['ppapPresetPromptText'],
  ppapPresetPromptMaxBytes: ['ppapPresetPromptMaxBytes'],
  ppapUpstreamConcurrencyDefault: ['ppapUpstreamConcurrencyDefault'],
