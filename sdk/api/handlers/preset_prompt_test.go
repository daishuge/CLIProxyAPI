...
func contextWithPresetPromptAPIKey(apiKey string) context.Context {
	...
	// In v7 the access middleware stores the authenticated principal under "userApiKey";
	// mirror that here so per-key preset prompt resolution can find the override.
