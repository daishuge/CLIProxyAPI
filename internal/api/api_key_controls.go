...
// apiKeyModelPrice aliases the shared pricing type so the enforcement and
// management paths always use the same built-in and external price sources.
...
//
// See internal/pricing for precedence and external-file loading behavior.
